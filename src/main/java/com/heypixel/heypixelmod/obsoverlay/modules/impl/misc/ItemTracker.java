        ...
        for (ItemTracker.TargetInfo info : this.entityPositions) {
            ...
            for (String entityTag : info.getDescription()) {
                Fonts.miSans
                        .render(
                                e.stack(),
                                I18n.get(entityTag),
                                info.getPosition().x + 10.0F,
                                (double) info.getPosition().y + y,
                                Color.RED,
                                true,
                                0.3F
                        );
                y += Fonts.miSans.getHeight(true, 0.3F);
            }
            ...
            if (this.debug.getCurrentValue() && info.getPlayer() != null) {
                ...
                for (String debugInfo : debugInfos) {
                    Fonts.miSans.render(e.stack(), debugInfo, info.getPosition().x + 10.0F, (double) info.getPosition().y + y, Color.RED, true, 0.35F);
                    y += Fonts.miSans.getHeight(true, 0.35F);
                }
            }
